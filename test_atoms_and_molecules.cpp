...
int main()
{
	...
	cout << "This molecule has the formula " << m2.get_formula() << " and weight " << m2.get_weight() << endl;
		//Should print out:
		//This molecule has the formula Cc and weight 5.6
...
//Note: from this point you need to start thinking about templates
	...
	cout << "This molecule has the formula " << m6.get_formula() << " and weight " << m6.get_weight() << endl;
		//Should print out:
		//This molecule has the formula Ss and weight 10.8
...
//rest should be already implemented
	...
	cout << m9.evaluate_chemical_equation(eq1);
		...
		//The molecule Cc3 has the weight 16.8 and is unstable with 8 loose bonds
	...
	cout << m10.evaluate_chemical_equation(eq2);
		//Should print out:
		//This is a Reaction
		//The resulting molecule is Cc4Hh2Ss3 and has the weight 59.6 and is unstable with 5 loose bonds
